...
const char* wifipassword =  "#######";          //password goes here

//database server details
IPAddress MySQL_server_address(###,###,##,###); //database server ip goes here
char MySQL_user[] = "#####";                    //database username goes here
char MySQL_password[] = "######";               //database password goes here
int MySQL_port = 3306;                          //port database server is listening to
